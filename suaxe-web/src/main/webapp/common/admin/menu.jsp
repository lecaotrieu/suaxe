...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition">
        ...
        <div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 570px;"></div>
                ...
                <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <c:if test="${not empty login_user}">
                            ...
                            <div class="image">
                                <img src="${imgUrl}" style="height: 30px;width: 30px;" class="img-circle elevation-2"
                                     alt="User Image">
                            </div>
                            <div class="info">
                                <a href="#" class="">${login_user.fullName}</a>
                            </div>
                            <a class="btn btn-outline-info" href="${logoutUrl}" role="button"><fmt:message
